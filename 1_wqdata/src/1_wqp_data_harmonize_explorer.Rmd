...
secchi <- read_feather(sc_retrieve('1_wqdata/out/wqp/all_raw_secchi.feather.ind')) %>%
  wqp.renamer() 
...
```{r}
#Read in the raw data from '1_wqdata/out'
tss <- read_feather(sc_retrieve('1_wqdata/out/wqp/all_raw_tss.feather.ind')) %>%
  wqp.renamer()
...
#Summarize by characteristic name and unit code
doc <- read_feather(sc_retrieve('1_wqdata/out/wqp/all_raw_doc.feather.ind')) %>%
  wqp.renamer() 
...
```{r Chlorophyll}
#Read in the raw data from '1_wqdata/out'
chl <- read_feather(sc_retrieve('1_wqdata/out/wqp/all_raw_chlorophyll.feather.ind')) %>%
  wqp.renamer() 
```
