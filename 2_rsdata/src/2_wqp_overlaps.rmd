...
In order to avoid sending up extraneous data to the WQP portal, we check for the PATH and ROW of each site that is near landsat-detectable water (from step "1_LandsatSiteInventory.Rmd"). Eventually this data will be joined to the actuall concentration data in 3_Flat_Overpasses.Rmd
