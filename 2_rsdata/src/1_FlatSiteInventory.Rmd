...
#turn our inventory into a feature collection by assigning lat longs and a site ide
  invOut = ee.FeatureCollection([ee.Feature(
            ee.Geometry.Point([inv['long'][i], inv['lat'][i]]),
              {'SiteID':inv['SiteID'][i]}) for i in range(x, x + 5000)]) #SIMON CAN YOU EXPLAIN THIS? FOR LOOP?
