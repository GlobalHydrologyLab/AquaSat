...
data.splitter <- function(wqp.nest,dir='2_rsdata/out/split_wide/'){
...
data.splitter(wqp.nest,dir='2_rsdata/out/split_wide/')
...
split.files <- list.files('2_rsdata/out/split_wide',full.names=T)
split.names= list.files('2_rsdata/out/split_wide')

for(i in 1:length(split.files)) {
  drive_upload(split.files[i], paste0('watersat/2_rsdata/out/split_wide/',split.names[i]))
}
