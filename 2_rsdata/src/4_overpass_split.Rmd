...
#Read in data
wqp.pull <- read_feather(sc_retrieve('2_rsdata/out/wide_pull.feather.ind')) %>%
  arrange(lat,long)
...
You should expect `r length(dir('2_rsdata/tmp/split_wide/'))` files in split_wide. These will be needed on GEE for the next step.
