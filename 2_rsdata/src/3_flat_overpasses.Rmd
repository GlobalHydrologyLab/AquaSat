...
unq.inv <- read_feather('2_rsdata/tmp/unique_site_inventory.feather')

#Grab back source column (lagos or wqp)
wrs.source.inv <- wrs.inv %>%
  left_join(unq.inv,by=c('SiteID','lat','long'))
...
write_feather(wqp.pull,path='2_rsdata/out/wide_pull.feather')


drive_upload('2_rsdata/out/wide_pull.feather', 'watersat/2_rsdata/out/')
